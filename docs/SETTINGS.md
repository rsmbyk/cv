...
- **Spacing gaps:** `gap-photo-name`, `gap-side-section`, `gap-main-section`, `gap-timeline-items`, `gap-list-items`, `gap-icon-title`, `gap-icon-contact`, `gap-title-line`, `gap-underline-content`, `gap-title-subtitle`, `gap-subtitle-content`, `gap-title-content`
